...
const literalReplacements = new Map([
  ...
  ["[REQUIRED — a monitored address; a contact form alone is not sufficient]", "<a href=\"mailto:info@contextter.com\">info@contextter.com</a>"],
  ...
  ["[REQUIRED — email address for data protection enquiries]", "<a href=\"mailto:info@contextter.com\">info@contextter.com</a>"],
