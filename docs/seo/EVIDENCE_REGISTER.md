...
| V2 | The live build is indexable and its robots file allows crawling and references one canonical sitemap. | Live `/robots.txt`; `/sitemap.xml/`, 2026-08-29. | Do not add a noindex gate or sitemap index for this small site. |
